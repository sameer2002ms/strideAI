      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-[#111827]/80 backdrop-blur-sm border-b border-[#27272A] flex items-center justify-between px-6 flex-shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/settings"
              className="w-8 h-8 rounded-full bg-[#27272A] flex items-center justify-center text-xs font-semibold text-gray-300 cursor-pointer hover:ring-2 hover:ring-[#FACC15]/40 transition-all duration-200"
            >
              {(user?.username || user?.email || "U").slice(0, 1).toUpperCase()}
            </Link>
          </div>
